            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- form start -->
                        <form action="{{ route('users_process/', $data['id']) }}" method="POST"
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control " id="name" name="name"
                                        placeholder="Input User Name" value="{{ $data['name'] }}" maxlength="255">
                                    <small>Maximal 255 characters</small>
                                </div>
                                <div class="form-group">
                                    <label for="email">Email <small class="text-danger">*</small></label>
                                    <input type="email" class="form-control " id="email" name="email"
                                        placeholder="Input User Email" value="{{ $data['email'] }}" maxlength="255">
                                    <small>Maximal 255 characters</small>
                                </div>
                                <div class="form-group">
